...
public class VolumeInfo extends Controller implements ControllerInfo{
...
//	private double offValue;
	...
	public VolumeInfo(String name, int track, double offValue, int trackType){	// use this if you want to not use the default name 'pan' for this control
		this.messageName = name;
		this.track = track;
		this.offValue = offValue;
		this.trackType = trackType;
	}
	public VolumeInfo(int track, double offValue, int trackType){		// uses default name 'pan'
		this.track = track;
		this.offValue = offValue;
		this.trackType = trackType;
	}
